...
# download data
ws1 <- read.csv(file = "~/Desktop/au/semester 3/STAT613/project/project-sales-and-branding/data/Datafiniti_Womens_Shoes_Jun19.csv")
# read other data
ws2 <- read.csv(file = "~/Desktop/au/semester 3/STAT613/project/project-sales-and-branding/data/Datafiniti_Womens_Shoes.csv")
ws3 <- read.csv(file = "~/Desktop/au/semester 3/STAT613/project/project-sales-and-branding/data/7003_1.csv")  
